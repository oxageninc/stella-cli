...
pub fn demo_inbound(started_ms: u64, self_pid: u32) -> Vec<Inbound> {
    ...
    vec![
        ...
        ev(lead, AgentEvent::StepUsage { step: 1, role: ModelCallRole::Worker, provider: "zai".into(), model: "glm-5.2".into(), input_tokens: 12_400, output_tokens: 640, cached_input_tokens: 9_000, cache_write_tokens: 0, estimated_input_tokens: 12_000, cost_usd: 0.021, duration_ms: 1830, retries: 0, tool_calls: 0, complete: true }),
        ...
        ev(lead, AgentEvent::StepUsage { step: 2, role: ModelCallRole::Worker, provider: "zai".into(), model: "glm-5.2".into(), input_tokens: 8_200, output_tokens: 900, cached_input_tokens: 6_000, cache_write_tokens: 0, estimated_input_tokens: 8_000, cost_usd: 0.018, duration_ms: 2100, retries: 0, tool_calls: 1, complete: true }),
        ...
        ev(auth, AgentEvent::StepUsage { step: 1, role: ModelCallRole::Worker, provider: "zai".into(), model: "glm-5.2".into(), input_tokens: 5_100, output_tokens: 420, cached_input_tokens: 3_000, cache_write_tokens: 0, estimated_input_tokens: 5_000, cost_usd: 0.011, duration_ms: 1400, retries: 0, tool_calls: 1, complete: true }),
        ...
        ev(ci, AgentEvent::StepUsage { step: 1, role: ModelCallRole::Worker, provider: "zai".into(), model: "glm-5.2-air".into(), input_tokens: 3_000, output_tokens: 180, cached_input_tokens: 0, cache_write_tokens: 0, estimated_input_tokens: 2_900, cost_usd: 0.004, duration_ms: 900, retries: 0, tool_calls: 0, complete: true }),
