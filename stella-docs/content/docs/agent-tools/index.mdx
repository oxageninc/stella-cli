...
All told: 18 always-on tools, up to 30 native tools with the code graph, media keys, and an issue backend, plus the six session tools — before any custom script tools or MCP servers merge in.
