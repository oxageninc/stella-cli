---
title: Agent Fleets
description: Fan a dependency-ordered task DAG out to parallel worker agents in one shared tree, coordinated by cooperative file claims — with per-task worktree isolation as the opt-in, a SQLite ledger of every attempt and dollar, and an optional CI watch.
---
