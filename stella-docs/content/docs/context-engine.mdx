...
protocol: the **[Open Context Protocol](https://github.com/macanderson/context-graph-protocol)**
...
[the OCP advantages paper](https://github.com/macanderson/context-graph-protocol/blob/main/docs/protocol-advantages.md).
